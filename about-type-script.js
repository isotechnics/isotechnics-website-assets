  ...
  function wordAnimation() {
    setTimeout(() => {
      ...
      let tl1 = gsap.timeline({
        scrollTrigger: {
          trigger:
            document.querySelector(".anim-scroll1").parentElement.parentElement
              .parentElement,
          start: "top 80%",
          end: "top 80%",
        },
      ...
      let tl2 = gsap.timeline({
        scrollTrigger: {
          trigger:
            document.querySelector(".anim-scroll2").parentElement.parentElement
              .parentElement,
          start: "top 80%",
          end: "top 80%",
        },
      ...
      let tl3 = gsap.timeline({
        scrollTrigger: {
          trigger:
            document.querySelector(".anim-scroll3").parentElement.parentElement
              .parentElement,
          start: "top 80%",
          end: "top 80%",
        },
